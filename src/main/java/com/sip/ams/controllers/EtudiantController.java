...
public class EtudiantController {
	...
	public ModelAndView listStudents(/* Model model */) {
		 ...
		 * Etudiant(1,"ali","ali@gmail.com")); etudiants.add(new
		 * Etudiant(2,"salah","salah@gmail.com")); etudiants.add(new
		 * Etudiant(3,"mohamed","mohamed@gmail.com"));
		 */
		// model.addAttribute("products",products);
	...
	public ModelAndView getFormUpdate(@PathVariable("ide") int id) {
		Etudiant e = new Etudiant();
		ModelAndView mv = new ModelAndView();
		System.out.println("id = " + id);
		e = recherche(etudiants, id);
